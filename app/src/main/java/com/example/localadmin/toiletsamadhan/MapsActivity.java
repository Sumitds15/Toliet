...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myLat = getIntent().getDoubleExtra("lat",44.45);
        myLng = getIntent().getDoubleExtra("long",14.45);
...
//        LatLng myLocation = new LatLng(12.925478, 77.6854875);
        ...
        mMap.animateCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(myLat,myLng), 16.0f));
